...
export default async function UniversitiesDirectoryPage({
  ...
  return (
    <main className="from-background via-muted/40 to-background bg-gradient-to-b py-10 pb-24">
      <Container className="max-w-[1500px]">
        ...
        <form
          className="mt-8 rounded-3xl border border-border bg-card p-4 shadow-[0_12px_35px_rgba(15,23,42,0.06)] ring-1 ring-border/40 sm:flex sm:items-center sm:gap-3"
          action="/universities"
          method="get"
        >
