...
import { dashboardInsightShell } from '@/modules/dashboard/lib/dashboard-theme';
import {
...
export const metadata: Metadata = {
	...
	description: 'Admin dashboard for managing the MeroUniversität platform.'
};
			...
			<section className="grid gap-6 lg:grid-cols-4">
				...
				>
					...
					<p className="text-muted-foreground mt-2 text-sm leading-relaxed">
						Approve or reject acceptance submissions before they appear
						publicly.
					</p>
	...
	return (
		<div className="rounded-3xl border border-slate-200/80 bg-white p-5 ring-1 ring-slate-900/5">
			...
			<div className="mt-3 flex items-center justify-between gap-2">
				<p className="text-3xl font-extrabold text-[#0d2145] tabular-nums">
					{value}
				</p>
				<div
