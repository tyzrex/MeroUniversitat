						...
						<div>
							...
							{!hasAcademicHint ? (
								<p className="mt-3 text-sm font-medium text-amber-800">
									Add GPA or percentage so your stats and community submissions
									stay consistent.
								</p>
							) : null}
						</div>
					...
					<div className="flex gap-4">
						...
						<div className="max-w-xl">
							...
							<p className="text-muted-foreground mt-2 text-sm leading-relaxed">
								Peer discovery is{' '}
								<strong className="text-[#0d2145]">off by default</strong>. Turn
								it on from your profile to let opted-in users near your GPA see
								which universities you track — never your documents or private
								Kanban notes.
							</p>
				...
				<div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
					<div className="flex gap-4">
						...
						<div>
							...
							<p className="text-muted-foreground mt-2 max-w-xl text-sm leading-relaxed">
								Submit outcomes or review moderation status. Forms pre-fill GPA
								and scores from your profile when you&apos;re signed in.
							</p>
