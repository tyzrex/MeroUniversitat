...
export const metadata: Metadata = {
	...
	description: 'Manage teams, members, roles, and shared application pipelines.'
};
		...
		<div className="flex flex-col gap-8">
			...
			<section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
				<SummaryCard
					...
					value={rows.length}
					icon={
						<UsersRound className="size-5 text-[#4a52c8]" strokeWidth={1.8} />
					}
				/>
				<SummaryCard
					label="Total members"
				...
				<SummaryCard
					...
					value={rows.length}
					icon={
						<Columns3 className="size-5 text-[#4a52c8]" strokeWidth={1.8} />
					}
				/>
			</section>
