		...
		<section className="relative overflow-hidden bg-white">
			...
			<Container className="py-10 lg:py-0">
				<div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
					{/* Left: Content */}
					<div className="animate-in fade-in slide-in-from-bottom-4 relative z-10 duration-500">
						<Badge
							variant="outline"
						...
						<h1 className="text-3xl leading-[1.12] font-extrabold tracking-tight text-balance text-[#0d2145] sm:text-4xl md:text-5xl lg:text-[3.75rem]">
							Germany applications made{' '}
							<span className="text-primary">transparent</span> for Nepali
							students.
						</h1>

						<p className="mt-5 max-w-xl text-sm leading-relaxed text-slate-500 lg:text-lg">
