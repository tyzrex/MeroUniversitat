				...
				<table className="w-full min-w-[760px] border-collapse text-sm">
					<thead>
						<tr className="border-b border-slate-200 bg-slate-50/95 text-left">
							<th className="px-4 py-3.5 pl-5 text-xs font-bold tracking-wide text-slate-500 uppercase">
								Milestone
							</th>
							<th className="px-3 py-3.5 text-xs font-bold tracking-wide text-slate-500 uppercase">
								Date reached
							</th>
							<th className="px-3 py-3.5 text-xs font-bold tracking-wide text-slate-500 uppercase">
								Expected next
							</th>
							<th className="min-w-[220px] px-3 py-3.5 text-xs font-bold tracking-wide text-slate-500 uppercase">
								Notes
							</th>
							<th className="w-[1%] px-4 py-3.5 pr-5 text-right text-xs font-bold tracking-wide whitespace-nowrap text-slate-500 uppercase">
								Actions
							</th>
						</tr>
					</thead>
