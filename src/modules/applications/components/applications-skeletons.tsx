...
export function ApplicationsTableSkeleton() {
	return (
		<div className="max-w-full min-w-0 overflow-hidden rounded-3xl border border-slate-200/80 bg-white ring-1 ring-slate-900/3">
			...
			<div className="overflow-x-auto overscroll-x-contain pb-2 [-webkit-overflow-scrolling:touch]">
				<div className="flex w-max gap-4">
					{Array.from({ length: 7 }).map((_, i) => (
						<div
							key={i}
							className="flex max-h-[min(86vh,920px)] min-h-[520px] w-[min(94vw,340px)] shrink-0 flex-col overflow-hidden rounded-xl border border-slate-200 bg-white p-3 sm:w-[310px] lg:w-[328px] xl:w-[360px]"
						>
