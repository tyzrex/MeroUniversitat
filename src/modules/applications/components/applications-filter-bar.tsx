      ...
      <div className="flex flex-col gap-3 lg:flex-row lg:flex-wrap lg:items-center">
        ...
        {teamOptions.length > 0 ? (
          <select
            ...
            className="h-10 min-w-[140px] rounded-xl border border-slate-200 bg-slate-50/50 px-3 text-sm font-medium text-slate-700 outline-none transition-colors focus:border-[#4a52c8]/40 focus:ring-2 focus:ring-[#4a52c8]/10"
          >
        ...
        <select
          ...
          className="h-10 min-w-[130px] rounded-xl border border-slate-200 bg-slate-50/50 px-3 text-sm font-medium text-slate-700 outline-none transition-colors focus:border-[#4a52c8]/40 focus:ring-2 focus:ring-[#4a52c8]/10"
        >
        ...
        >
          <SlidersHorizontal className="size-4 text-slate-500" strokeWidth={2} />
          Filters
        </button>
