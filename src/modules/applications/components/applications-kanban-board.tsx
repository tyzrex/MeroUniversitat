						...
						{KANBAN_COLUMNS.map((col) => {
							...
							return (
								<div
									key={col.id}
									className={cn(
										'flex max-h-[min(86vh,920px)] min-h-[400px] w-[min(94vw,340px)] shrink-0 flex-col overflow-hidden rounded-xl border bg-white p-3 transition-colors sm:w-[310px] lg:w-[328px] xl:w-[360px]',
										isDropTarget
								...
								>
									<div className="mb-3 flex shrink-0 items-start justify-between gap-2 border-b border-slate-100 pb-2">
		...
		<section className="rounded-2xl border border-slate-200 bg-white p-6">
			<div className="flex flex-col gap-4 border-b border-slate-100 pb-4 sm:flex-row sm:items-center sm:justify-between">
				<div className="flex min-w-0 items-center gap-3">
					<UniversityLogo name={leadName} logoUrl={leadLogo} size="compact" />
					<div className="min-w-0">
		...
		return (
			...
			>
				...
				<div className="min-w-0 flex-1">
					...
					<p className="truncate leading-tight font-semibold text-[#0d2145]">
						{card.universityName}
					</p>
		...
		>
			...
			<div className={cn('flex gap-3', boardCard && isOwner && 'pr-9')}>
				...
				<div className="min-w-0 flex-1">
					...
					<p className="leading-snug font-semibold text-[#0d2145]">
						{card.universityName}
					</p>
					...
					{isOwner ? (
						boardCard ? null : (
							<div
								...
								onMouseDown={(e) => e.stopPropagation()}
							>
								<label className="text-muted-foreground block text-[10px] font-bold tracking-[0.14em] uppercase">
									Status
								</label>
								<select
