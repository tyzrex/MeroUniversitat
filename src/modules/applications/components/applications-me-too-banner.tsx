export function ApplicationsMeTooBanner() {
  return (
    ...
    >
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute -bottom-6 right-4 hidden h-28 w-36 rounded-2xl bg-sky-100/90 opacity-90 shadow-inner md:block"
      />
      <div
        aria-hidden
        className="pointer-events-none absolute -right-4 top-8 hidden size-24 rounded-full bg-blue-200/40 blur-2xl md:block"
      />
    </section>
  );
}
