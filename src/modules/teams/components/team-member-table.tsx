    ...
    <div className="overflow-hidden rounded-3xl border border-border bg-card shadow-[0_12px_35px_rgba(15,23,42,0.06)] ring-1 ring-border/40">
      <div className="border-b border-border px-6 py-5">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          People in this team can see and share applications on the same Kanban board.
        </p>
      </div>
      ...
      <td className="px-6 py-4">
        <div className="flex items-center gap-3">
          {member.user.image ? (
            ...
            <div className="flex size-9 items-center justify-center rounded-full bg-gradient-to-br from-muted to-muted/80 text-xs font-bold text-muted-foreground ring-2 ring-border">
              {initials}
            </div>
          )}
            ...
            <div className="relative inline-block">
              ...
              {showActions ? (
                <>
                  ...
                  />
                  <div className="absolute right-0 z-50 mt-1 w-48 rounded-xl border border-border bg-card p-1.5 shadow-lg">
                    {isOwner ? (
                      <button
                        type="button"
                        onClick={handleRoleToggle}
                        disabled={isPending}
                        className="flex w-full items-center gap-2 rounded-lg px-3 py-2 text-left text-sm font-medium text-foreground transition-colors hover:bg-muted disabled:opacity-60"
                      >
                        <UserCog
