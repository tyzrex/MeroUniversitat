        ...
        <div className="flex flex-wrap gap-4">
          <div className="min-w-[200px] flex-1">
            ...
            <select
              ...
              className="flex h-10 w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-700 outline-none ring-[#4a52c8]/30 focus-visible:ring-2"
            >
